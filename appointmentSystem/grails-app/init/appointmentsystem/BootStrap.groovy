...
fullName:'James Hill', qualifications:'PHD', position:'Senior Doctor', doctorEmail:'DrHill@sheffsurgeries.co.uk', password:'password', doctorOffice:'D-9444', doctorPhone:'01623456789', bio:'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', surgery:CityHealthCentre).save()

def DrMacdonald = new com.mwelsh.Doctor(
fullName:'Sarah Macdonald', qualifications:'MBChB', position:'GP, Surgeon', doctorEmail:'DrMacdonald@sheffsurgeries.co.uk', password:'secret222', doctorOffice:'D-9888', doctorPhone:'01111777', bio:'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', surgery:HallamHealth).save()

def RobKingstone = new com.mwelsh.Receptionist(
recepName:'Rob Kingston', recepEmail:'r.kingson@email.com', recepUsername:'rking', recepPassword:'secret2019', recepPhone:'01142224445', surgery:CityHealthCentre).save()

def DebbieClarke = new com.mwelsh.Receptionist(
recepName:'Debbie Clarke', recepEmail:'d.clarke@email.com', recepUsername:'dclarke', recepPassword:'hidden2019', recepPhone:'01142224447', surgery:HallamHealth).save()

def SusanPeters = new com.mwelsh.Nurse(
nurseName:'Susan Peters', qualifications:'Registered General Nurse', nurseEmail:'s.peters@myemail.com', nurseOffice:'B-455', nursePhone:'01142224433', surgery:CityHealthCentre).save()

def BeckyWelsh = new com.mwelsh.Nurse(
nurseName:'BeckyWelsh', qualifications:'Registered Senior Nurse', nurseEmail:'b.welsh@myemail.com', nurseOffice:'B-423', nursePhone:'01153337711', surgery:HallamHealth).save()

def Appointment1 = new com.mwelsh.Appointment(
appDate:new Date('11/04/2019'), appTime:'3:00pm', appDuration:'30 Minutes', roomNumber:'A-1111', patient:'', doctor:DrHill).save()

def Appointment2 = new com.mwelsh.Appointment(
appDate:new Date('26/05/2020'), appTime:'5:00pm', appDuration:'45 Minutes', roomNumber:'A-1234', patient:'', doctor:DrMacdonald).save()
...
pharmacyName:'City Centre Pharmacy', prescripNumber:'56788', medicine:'Paracetomol', totalCost:'£5.90', dateIssued:new Date('25/05/2019'), patientPaying:true, doctor:DrHill, patient:TomRivers).save()

def HallamPharmacy = new com.mwelsh.Prescription(
pharmacyName:'Hallam Pharmacy', prescripNumber:'12345', medicine:'Ibuprofen', totalCost:'£3.20', dateIssued:new Date('17/02/2019'), patientPaying:false, patient:JakeWright).save()


CityHealthCentre.addToPatients(TomRivers)
HallamHealth.addToPatients(JakeWright)

CityHealthCentre.addToAppointments(Appointment1)
HallamHealth.addToAppointments(Appointment2)

SusanPeters.addToDoctors(DrHill)
SusanPeters.addToDoctors(DrMacdonald)
BeckyWelsh.addToDoctors(DrMacdonald)
BeckyWelsh.addToDoctors(DrHill)

Appointment1.addToSurgerys(CityHealthCentre)
Appointment2.addToSurgerys(HallamHealth)
Appointment2.addToSurgerys(HallamHealth)

DrHill.addToPatients(TomRivers)
